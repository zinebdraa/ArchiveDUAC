  ...
  const handleSearch = (query) => {
    ...
    const fetchDocuments = async () => {
      try {
        ...
        const filtered = chemiseId
          ? allDocuments.filter((d) => d.chemiseId === Number(chemiseId))
          : allDocuments;
            ...
            {results.length > 0 ? (
              <div>
                {results.map((chemise) => (
                  ...
                  >
                    <div
                      onClick={() => toggleSelect(chemise.id)}
                    ...
                    <div className="flex justify-center space-x-2">
                      ...
                      <TbTrashX
                        ...
                        // onClick={() => handleDelete(chemise.id)}
                      />
                    </div>
                  </div>
                ))}
